...
Public Class clsCantidad
    ...
    Private Shared Datos As Controlador.clsArticulos.eArticuloCuerpoDocumento ' DataTable
    ...
    Public Property CompCantidadUnidades() As Integer
        ...
        End Set
    End Property
    Public Property CompDatos() As Controlador.clsArticulos.eArticuloCuerpoDocumento ' DataTable
        Get
            Return Me.Datos
        End Get
        Set(ByVal Value As Controlador.clsArticulos.eArticuloCuerpoDocumento)
            Me.Datos = Value
        End Set
    End Property
