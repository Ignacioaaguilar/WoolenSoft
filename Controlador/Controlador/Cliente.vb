...
Public Class Cliente
    ...
    Public Property CompLocalidad() As String
        ...
        End Set
    End Property
    Public Sub llenar_tabla_cliente(ByVal cadena As String, ByRef grilla As DataGridView)
    ...
    End Sub
    Public Sub Validar_Cliente(ByVal consulta As String, ByRef existe As Boolean)
        Dim conectar As New coneccion()
    ...
    Public Sub ObtenerIdConsumidorFinal(ByVal consulta As String, ByRef datos As DataTable)
        ...
        datos = conectar.consulta_reader(consulta)
    End Sub
    Public Sub ObtenerUltimoNumeroCliente(ByVal consulta As String, ByRef Ultimo As Integer)
        Dim conectar As New coneccion()
