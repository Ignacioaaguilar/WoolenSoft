...
Public Class Cantidad
    ...
    Private Shared Datos As Controlador.Articulos.eArticuloCuerpoDocumento ' DataTable
    ...
    Public Property CompCantidadUnidades() As Integer
        ...
        End Set
    End Property
    Public Property CompDatos() As Controlador.Articulos.eArticuloCuerpoDocumento ' DataTable
        Get
            Return Me.Datos
        End Get
        Set(ByVal Value As Controlador.Articulos.eArticuloCuerpoDocumento)
            Me.Datos = Value
        End Set
    End Property
