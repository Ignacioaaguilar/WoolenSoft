Public Class NumeroComprobante
    ...
    Private Sub DGVNumeroComprobante_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles DGVNumeroComprobante.Click
        ...
        Try
            ...
            NumeroComprobanteAlta.codigo_NumeroComprobante = id_Comprobante
            NumeroComprobanteAlta.TBDescripcion.Text = DGVNumeroComprobante.CurrentRow.Cells(DfieldDefNumeroComprovante.Descripcion).Value.ToString()
            NumeroComprobanteAlta.TBNumeracion.Text = DGVNumeroComprobante.CurrentRow.Cells(DfieldDefNumeroComprovante.Numeracion).Value.ToString()
            NumeroComprobanteAlta.CBNumeroEmpresa.Text = DGVNumeroComprobante.CurrentRow.Cells(DfieldDefNumeroComprovante.Id_Empresa).Value.ToString()
