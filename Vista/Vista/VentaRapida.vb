    ...
    Private Sub ToolStripRegistrarVentaRapida_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripRegistrarVentaRapida.Click
        ...
        If Convert.ToDouble(txtSubTotal.Text) > 0 Then
            ...
            Try
                ...
                VentaRapida.Limpiar_Datos_ComprobanteVentaRapida(Vista.NotaCredito.dgvNotaCredito, Vista.NotaCredito.txtSubTotal, Vista.NotaCredito.txtDescuento, Vista.NotaCredito.txtIVa, Vista.NotaCredito.txtTotal, Vista.NotaCredito.txtnumeroComprobante, Vista.NotaCredito.lblTipoComprobante, Vista.NotaCredito.lblIdComprobante)
                LimpiarEstructuras()
                Vista.NotaCredito.lblCodN.Visible = False
                Vista.NotaCredito.txtCodigoCliente.Text = ""
                Me.Close()
                LimpiarEstructuras()
                VentaRapida.Limpiar_Datos_ComprobanteVentaRapida(dgvVentaRapida, txtSubTotal, txtDescuento, txtIVa, txtTotal, txtnumeroComprobante, lblTipoComprobante, lblIdComprobante)
                lblCodN.Visible = False
