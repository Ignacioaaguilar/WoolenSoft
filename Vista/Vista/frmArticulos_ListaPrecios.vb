                        ...
                        If Not (existe) Then
                            ...
                            If (frmArticulosAltas.CBPesable.Text = dfieldefConstantes.Si.ToString()) Then
                                Try
                                    ...
                                    articulo.llenar_tabla_Producto_Lista_Precio_Lista_Precio(frmArticulosAltas.DGVListaPrecio, ArticuloListaPrecio_estructura(1).IdProducto)
                    ...
                    If (TBCodigoProducto.Text <> "" And TBPrecioCosto.Text <> "" And TBRentabilidad.Text <> "" And TBPrecioVenta.Text <> "" And TBPrecioKilo.Text <> "") Then
                        ...
                        If (frmArticulosAltas.CBPesable.Text = dfieldefConstantes.Si.ToString()) Then
                            Try
                                ...
                                articulo.llenar_tabla_Producto_Lista_Precios_Lista_Precio(ArticuloListaPrecio_estructura(1).IdProducto, frmArticulosAltas.DGVListaPrecio)
