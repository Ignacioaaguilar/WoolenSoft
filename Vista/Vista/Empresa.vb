...
Public Class Empresa
    ...
    Private Sub DGVEmpresa_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles DGVEmpresa.Click
        ...
        Try
            ...
            EmpresaAlta.codigo_Empresa = id_Empresa
            EmpresaAlta.TBRazonSocial.Text = DGVEmpresa.CurrentRow.Cells(dfielddefEmpresa.Razon_Social).Value.ToString()
            EmpresaAlta.TBCalle.Text = DGVEmpresa.CurrentRow.Cells(dfielddefEmpresa.Calle).Value.ToString()
            EmpresaAlta.TBPiso.Text = DGVEmpresa.CurrentRow.Cells(dfielddefEmpresa.Piso).Value.ToString()
            EmpresaAlta.TBNro.Text = DGVEmpresa.CurrentRow.Cells(dfielddefEmpresa.Nro).Value.ToString()
            EmpresaAlta.TBLocalidad.Text = DGVEmpresa.CurrentRow.Cells(dfielddefEmpresa.Localidad).Value.ToString()
            EmpresaAlta.TBCodigoPostal.Text = DGVEmpresa.CurrentRow.Cells(dfielddefEmpresa.Codigo_Postal).Value.ToString()
            empresa.Descomponer_CUIT_Empresas(DGVEmpresa.CurrentRow.Cells(dfielddefEmpresa.CUIT).Value.ToString(), cuit1, cuit2, cuit3)
            EmpresaAlta.TBCuit1.Text = cuit1
            EmpresaAlta.TBCuit2.Text = cuit2
            EmpresaAlta.TBCuit3.Text = cuit3

            EmpresaAlta.TBIngresosBrutos.Text = DGVEmpresa.CurrentRow.Cells(dfielddefEmpresa.Ingresos_Brutos).Value.ToString()
            EmpresaAlta.CBResponsabilidadIVA.Text = DGVEmpresa.CurrentRow.Cells(dfielddefEmpresa.Responsabilidad_IVA).Value.ToString()
            EmpresaAlta.TBNroSucursal.Text = DGVEmpresa.CurrentRow.Cells(dfielddefEmpresa.Nro_Sucursal).Value.ToString()
            EmpresaAlta.CBProvincia.Text = DGVEmpresa.CurrentRow.Cells(dfielddefEmpresa.Provincia).Value.ToString()
    ...
    Private Sub ToolStripNuevaEmpresa_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripNuevaEmpresa.Click
        ...
        Next
        Me.Close()
        empresa.Limpiar_Datos_Empresas(EmpresaAlta.TBRazonSocial, EmpresaAlta.TBCalle, EmpresaAlta.TBPiso, EmpresaAlta.TBNro, EmpresaAlta.TBLocalidad, EmpresaAlta.TBCodigoPostal, EmpresaAlta.TBCuit1, EmpresaAlta.TBCuit2, EmpresaAlta.TBCuit3, EmpresaAlta.TBIngresosBrutos, EmpresaAlta.TBNroSucursal)
        EmpresaAlta.Show()
