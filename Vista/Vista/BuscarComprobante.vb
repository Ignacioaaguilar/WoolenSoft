        ...
        Try
            ...
            Else
                If facturacion.Compvariable = dfieldefConstante.NotaCredito.ToString() Then
                    ...
                    Vista.NotaCredito.txtCodigoCliente.Text = idCliente
                    Vista.NotaCredito.dgvNotaCredito.DataSource = Nothing
                    For idx = 0 To datosCuerpoFact.Rows.Count - 1
                        Vista.NotaCredito.txtBusquedaArticulo.Text = datosCuerpoFact.Rows(idx).Item(dfielddefCuerpoFact.Numero_Articulo).ToString()
                    Next
                Else
                    If facturacion.Compvariable = dfieldefConstante.NotaDebito.ToString() Then
                        ...
                        Vista.NotaDebito.txtCodigoCliente.Text = idCliente
                        Vista.NotaDebito.dgvNotaDebito.DataSource = Nothing
                        For idx = 0 To datosCuerpoFact.Rows.Count - 1
                            Vista.NotaDebito.txtBusquedaArticulo.Text = datosCuerpoFact.Rows(idx).Item(dfielddefCuerpoFact.Numero_Articulo).ToString()
                        Next
                    Else
                        If facturacion.Compvariable = dfieldefConstante.VentasRapidas.ToString() Then
                            ...
                            Vista.VentaRapida.dgvVentaRapida.DataSource = Nothing
                            For idx = 0 To datosCuerpoFact.Rows.Count - 1
                                Vista.VentaRapida.txtBusquedaArticulo.Text = datosCuerpoFact.Rows(idx).Item(dfielddefCuerpoFact.Numero_Articulo).ToString()
                            Next
                        End If
                    End If
                End If
